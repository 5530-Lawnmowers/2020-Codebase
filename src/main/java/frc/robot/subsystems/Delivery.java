...
public class Delivery extends SubsystemBase {
    ...
    public void periodic() {
        ...
        ShuffleboardHelpers.setWidgetValue("Intake/Delivery", "Breakbeam 1", deliverySensor1.get());
        ShuffleboardHelpers.setWidgetValue("Intake/Delivery", "Breakbeam 2", deliverySensor2.get());
        ShuffleboardHelpers.setWidgetValue("Intake/Delivery", "Breakbeam 3", deliverySensor3.get());
        ShuffleboardHelpers.setWidgetValue("Intake/Delivery", "Breakbeam 4", deliverySensor4.get());
        ShuffleboardHelpers.setWidgetValue("Intake/Delivery", "Breakbeam 5", deliverySensor5.get());
    }
